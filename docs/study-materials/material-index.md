...
| B | 社区教程 / 博客 / 复现仓库 / 经典中文长文 | 实践价值明显、作者可信、解释质量高时保留，建议标注为“中文补充 / 实践解读” |
| C | 聚合站、转载、短新闻、缺少出处的二手解读 | 原则上不作为核心引用；若保留需有替代官方来源 |

更新资料时优先用 S/A 层作为主引用；高质量中文文章、知乎经典长文和工程复盘不必一刀切替换，可作为 B 层补充保留。处理方式：主论点回到论文、官方文档、代码或一线作者文章，中文材料承担解释、实践经验和本土语境补充。
